          ...
          >
            <div className="grid sm:grid-cols-2 gap-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-lg border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 text-foreground placeholder:text-neutral-400 dark:placeholder:text-neutral-600 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/40 focus:border-blue-500 transition-colors"
                />
              </div>
              <div>
                <label
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-2.5 rounded-lg border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 text-foreground placeholder:text-neutral-400 dark:placeholder:text-neutral-600 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500/40 focus:border-blue-500 transition-colors resize-none"
              />
            </div>
          ...
          >
            ...
            <div className="rounded-xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-5">
              ...
              <a
                ...
                className="text-sm text-foreground font-medium hover:text-blue-500 transition-colors break-all"
              >
                {siteConfig.email}
              </a>
            </div>
            ...
            <div className="rounded-xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-5">
              ...
              <div className="space-y-2">
                <a
                  ...
                  className="flex items-center gap-2 text-sm text-foreground font-medium hover:text-blue-500 transition-colors"
                >
